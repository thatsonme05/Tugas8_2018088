...
import com.example.a2018088_tugas8.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        insertData();
        editData();
        binding.edtimage.setOnClickListener(new
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Long rec = sqLiteDatabase.insert("tradisional",null ,cv);if (rec != null) {
        ...
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(recedit != -1){
                    ...
                    Intent a = new Intent(MainActivity.this, DisplayData.class);
                    startActivity(a);
                }
            }
        });
